...
export let GAMES:IGame[]= [ 
    ...
    { name: "Cupcake Patrol", imageURL: "test4.url", solo: {first: 9999, second: 9999, third: 9999}, multi: {first: 9999, second: 9999, third: 9999}},
    { name: "MightBeHundry Patrol", imageURL: "test5.url", solo: {first: 9999, second: 9999, third: 9999}, multi: {first: 9999, second: 9999, third: 9999}}];
